		...
		<div class="col-md-12 wrapper-background">
			<nav class="navbar nav2 nav navbar-nav">
				<div class="container-fluid">
					...
					<ul class="nav navbar-nav pull-right">
						<li><a target="_blank" href="" style="margin-left:2.5em; margin-top:.2em;"><span class="glyphicon glyphicon-print"> </span>&nbsp; Print Report</a></li>
					</ul>
				</div>
			</nav>
			...
			<form name="calz" method="post">
			  ...
			  <?php
				...
				$sql = "SELECT * FROM tbl_endorsement a, tbl_applicant b, tbl_basic_info c, tbl_client d, tbl_job_posting e
					...
					AND endorsementDate BETWEEN '$start' AND '$end' AND d.clientId = $_SESSION[login_userId] AND endorsementStatus = 'Employed'";
			...
			echo "List of All Endorsed Applicants";
				...
				mysql_close($con); 
				  ...
				  ?>
				<form name="calz" method="post" target="_blank" action="../fpdf/pdfEndorsementSummary.php" >
