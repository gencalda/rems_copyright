			...
			<br />
				<div class='container-fluid content'>
					...
					<?php	
							...
							echo " title: ".$_SESSION["ses_jobPostingTitle"];
							...
							echo "</br><input type='submit'  class='btn btn-default' name='name_jobPostingQualitiesOthersAdd' id='name_jobPostingQualitiesOthersAdd'  style='display:none; margin-left:20px; margin-top:1em;'  Value='Add to List'/></p>";
							echo "</div>";
							...
							echo " <form action='../../../config/insertJobQualificationsQualitiesFromClients.php' method='post'>";
							...
							//echo "<input type='submit' name='submit' Value='Add Position'/>";
								...
								echo "<script language='JavaScript'>
									...
									function enableQualities(status)
									{
										...
										if (status==true)
										{
										document.getElementById('name_jobPostingQualitiesOthersAdd').style.display = 'block';
										}
										else
										{
										document.getElementById('name_jobPostingQualitiesOthersAdd').style.display = 'none';
										}
									}
