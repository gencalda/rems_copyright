...
?>
		...
		<div class="container-fluid col-md-12 content">
			<div class="container col-md-12" style="background-color: #f0f0f0; margin-bottom: 8em; margin-top: 3em; padding:1em;">
				...
				<form method="POST" action="../../../config/insertAppDesiredPosition.php" name = "myForm" enctype="multipart/form-data">
					...
					<legend>What position are you looking for?</legend>
							...
							<div class="form-group col-md-4">
										...
										mysql_select_db("$db_database", $con);
										$result = mysql_query("SELECT * FROM tbl_job_posting WHERE jobStatus=1 GROUP BY jobName");			
								...
								<input type="text" 												
										class="form-control" 
										name="name_appQualityExpectedSalary" 
										value='<?php echo $salaryExpectedFrom ?>' 
										maxlength="13"
										placeholder="" 
										id="name_appQualityExpectedSalary"
										required
						...
						<?php
							...
							echo"
							<script type='text/javascript'>
								var input = new Input('name_appQualityExpectedSalary', 'Php ');
								var userText = input.getUserText(); 
								
								var input = new Input('name_appQualityExpectedSalaryUpTo', 'Php ');
								var userText = input.getUserText(); 
								
								$('#name_appQualityExpectedSalary').keyup(function(e)
								{
