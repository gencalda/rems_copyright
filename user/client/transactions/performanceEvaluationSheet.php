			...
			<br /><br />
				<div class="container-fluid">
		      		<form class="form center-block" role="form"  action="demo.php?token=<?php echo $tran;?>" method='POST'>
						...
						echo"Score Legend:<br /><br />";
						echo"5 - Outstanding <br />";
						echo"4 - Exceeds Requirement <br />";
						echo"3 - Meets Requirement<br />";
						echo"2 - Needs Improvement<br />";
						echo"1 - Poor<br /><br />";
						?>
