...
<script type="text/javascript">			
	...
	<div class="container-fluid">
		<div class="col-md-12 wrapper-background">
			...
			<form name="calz" method="post">
				<div class="form-group col-md-1">
					<button class="btn btn-success" id="button" type="submitall" style="margin-top: 1.3em;" value="View All">
				</div>
			</form>
		  ...
		  <?php
			...
			$sql = "SELECT *
					...
					WHERE a.basicId = b.applicantId and a.basicId = c.basicId GROUP BY contactNumber ORDER BY applicantDate";
