		...
		<div class="col-md-12 wrapper-background">
		  ...
		  <?php
			...
			$sql = "SELECT *
					...
					applicantDate BETWEEN '$start' AND '$end' 
					GROUP BY basicEmail ORDER BY applicantDate";
					
			echo "Applicant who applied From $start To $end";
			...
			$sql = "SELECT *
					FROM tbl_basic_info a, tbl_applicant b, tbl_contact_info c
					WHERE a.basicId = b.basicId AND a.basicId = c.basicId 
					GROUP BY basicEmail ORDER BY applicantDate";
