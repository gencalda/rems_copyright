		...
		<div class="col-md-12" style="background-color: #f0f0f0; margin-bottom: 8em; margin-top: 3em; padding:1em;">
			...
			<br />
				<div class='container-fluid content'>
							...
							echo "</br><input type='submit'  class='btn btn-default' name='name_jobPostingQualitiesOthersUpdateClient' id='name_jobPostingQualitiesOthersUpdateClient'  style='display:none; margin-left:20px; margin-top:1em;'  Value='Add to List'/></p>";
							echo "</div>";
							...
							//echo "<input type='submit' name='submit' Value='Add Position'/>";
								...
								echo "<script language='JavaScript'>
									...
									function enableQualities(status)
									{
										...
										if (status==true)
										{
										document.getElementById('name_jobPostingQualitiesOthersUpdateClient').style.display = 'block';
										}
										else
										{
										document.getElementById('name_jobPostingQualitiesOthersUpdateClient').style.display = 'none';
										}
									}
