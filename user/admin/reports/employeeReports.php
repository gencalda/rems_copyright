	...
	<div class="container-fluid">
		<div class="col-md-12 wrapper-background">
			...
			<form name="calz" method="post">
			  ...
			  <?php
				...
				$sql = "SELECT * FROM tbl_employee a, tbl_applicant b, tbl_basic_info c, tbl_client d, tbl_job_posting e, tbl_contract f 
					...
					AND contractStartDate >= '$start' AND contractEndDate <= '$end' GROUP BY basicLastName, basicFirstName, basicMiddleName, basicExtName";
				
				echo "Employee Contract Records From $start To $end";
			...
			$sql = "SELECT * FROM tbl_employee a, tbl_applicant b, tbl_basic_info c, tbl_client d, tbl_job_posting e, tbl_contract f 
					...
					AND a.jobPostingId = e.jobPostingId 
					AND d.clientId = e.clientId
					AND f.employeeId = a.employeeId GROUP BY basicLastName, basicFirstName, basicMiddleName, basicExtName" ;
